...
__decorate([
    (0, common_1.Post)(),
    (0, permissions_decorator_1.RequirePermissions)('manage_roles'),
    (0, swagger_1.ApiOperation)({ summary: 'Create custom role' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get role details' }),
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)('manage_roles'),
    (0, swagger_1.ApiOperation)({ summary: 'Delete custom role' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
