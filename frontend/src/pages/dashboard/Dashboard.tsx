            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card className="relative overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 animate-fade-in">
                    ...
                    <CardHeader className="relative flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium text-white/90">{t('dashboard_page.totalRevenue')}</CardTitle>
                ...
                <Card className="relative overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 animate-fade-in" style={{ animationDelay: '0.1s' }}>
                    ...
                    <CardHeader className="relative flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium text-white/90">{t('dashboard_page.activeOrders')}</CardTitle>
                        <div className="h-10 w-10 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center">
                    ...
                    <CardContent className="relative">
                        ...
                        <div className="flex items-center gap-1 mt-1">
                            <TrendingUp className="h-4 w-4 text-green-200" />
                            <p className="text-sm text-white/80 font-medium">+180.1% {t('dashboard_page.fromLastMonth')}</p>
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="relative overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 animate-fade-in" style={{ animationDelay: '0.2s' }}>
                    ...
                    <CardHeader className="relative flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium text-white/90">{t('dashboard_page.productsInStock')}</CardTitle>
                        <div className="h-10 w-10 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center">
                    ...
                    <CardContent className="relative">
                        ...
                        <div className="flex items-center gap-1 mt-1">
                            <TrendingUp className="h-4 w-4 text-green-200" />
                            <p className="text-sm text-white/80 font-medium">+19% {t('dashboard_page.fromLastMonth')}</p>
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="relative overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 animate-fade-in" style={{ animationDelay: '0.3s' }}>
                    ...
                    <CardHeader className="relative flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium text-white/90">{t('dashboard_page.lowStockAlerts')}</CardTitle>
                    ...
                    <CardContent className="relative">
                        ...
                        <div className="flex items-center gap-1 mt-1">
                            ...
                            <p className="text-sm text-white/80 font-medium">{t('dashboard_page.requiresAttention')}</p>
                        </div>
                    </CardContent>
                </Card>
            </div>
